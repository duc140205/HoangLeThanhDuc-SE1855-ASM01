...
namespace DataAccessLayer
{
    public class CustomerDAO
    {
        ...
        {
            new Customer(1, "Tech Solutions", "Dang Mon", "IT Manager", "123 Tech Lane", 0987654321),
            new Customer(2, "Book Haven", "Khoi Mon", "Sales Manager", "456 Book St", 0934923124),
            new Customer(3, "Fashion Hub", "Dang Truong Hung", "Marketing Director", "789 Fashion Ave", 0934923125),
            new Customer(4, "Sports World", "Huynh Quang Huy", "Operations Manager", "321 Sports Blvd", 0934923126),
            new Customer(5, "Toy Kingdom", "Hoang Le Thanh Loc", "Product Manager", "654 Toy Rd", 0934923127)
        };
